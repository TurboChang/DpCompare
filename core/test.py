...
consumer1 = KafkaConsumer(bootstrap_servers='59.110.219.31:9092')
def kafka_python_consumer1():
    consumer1.subscribe(['topic1'])
    for msg in consumer1:
      print(msg)

consumer2 = KafkaConsumer(bootstrap_servers='59.110.219.31:9092')
def kafka_python_consumer2():
    consumer2.assign([TopicPartition('topic1', 1), TopicPartition('topic2', 1)])
    for msg in consumer2:
        print(msg)

consumer3 = KafkaConsumer(bootstrap_servers='59.110.219.31:9092')
